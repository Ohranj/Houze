<template x-for="toast in $store.toast.list">
    <template x-teleport="#c_alerts">
        <div class="border bg-white shadow shadow-xl min-w-[275px] max-w-[375px] z-[60] rounded-md grid grid-cols-12 items-center text-sm p-1.5 mt-1.5 relative overflow-hidden">
